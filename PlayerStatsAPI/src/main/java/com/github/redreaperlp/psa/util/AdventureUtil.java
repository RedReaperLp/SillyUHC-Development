package com.github.redreaperlp.psa.util;
...
public class AdventureUtil {
    ...
    public static void sendWithPrefix(Component message, CommandSender receiver) {
        if (message.color() == null) message = message.color(TextColor.color(0xffffff));
        send(receiver, PlayerStatsAPI.getPrefix.append(message));
    }
    ...
    public static void sendWithPrefix(Component message, Player... receivers) {
        for (Player receiver : receivers) {
